...
class Emojifier {
    ...
    static Bitmap detectFacesAndOverlayEmoji(Context context, Bitmap picture) {
        ...
        Bitmap overlayedPicture = picture;
            ...
            for (int i = 0; i < faces.size(); ++i) {
                ...
                switch (whichEmoji(face)){
                    ...
                    case CLOSED_EYE_FROWN:
                        ...
                        break;
                    default:
                        Toast.makeText(context, "Unknow face emoji!", Toast.LENGTH_SHORT).show();
                        emojiBitmap = null;
                }
                ...
                overlayedPicture = addBitmapToFace(overlayedPicture, emojiBitmap, face);
    ...
    private static Bitmap addBitmapToFace(Bitmap backgroundBitmap, Bitmap emojiBitmap, Face face) {
        ...
        float emojiPositionY =
                (face.getPosition().y + face.getHeight() / 2) - emojiBitmap.getHeight() / 2;
